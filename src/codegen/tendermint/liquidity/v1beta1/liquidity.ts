...
export interface PoolTypeProtoMsg {
  typeUrl: "/tendermint.liquidity.v1beta1.PoolType";
  value: Uint8Array;
}
/**
 * Structure for the pool type to distinguish the characteristics of the reserve
...
export interface PoolTypeAminoMsg {
  type: "/tendermint.liquidity.v1beta1.PoolType";
  value: PoolTypeAmino;
}
/**
 * Structure for the pool type to distinguish the characteristics of the reserve
...
export interface Params {
  ...
  buildersAddresses: string[];
  buildersCommission: string;
}
export interface ParamsProtoMsg {
  typeUrl: "/tendermint.liquidity.v1beta1.Params";
  value: Uint8Array;
}
/** Params defines the parameters for the liquidity module. */
export interface ParamsAmino {
  ...
  builders_addresses?: string[];
  builders_commission?: string;
}
export interface ParamsAminoMsg {
  type: "/tendermint.liquidity.v1beta1.Params";
  value: ParamsAmino;
}
/** Params defines the parameters for the liquidity module. */
...
export interface PoolProtoMsg {
  typeUrl: "/tendermint.liquidity.v1beta1.Pool";
  value: Uint8Array;
}
/** Pool defines the liquidity pool that contains pool information. */
...
export interface PoolAminoMsg {
  type: "/tendermint.liquidity.v1beta1.Pool";
  value: PoolAmino;
}
/** Pool defines the liquidity pool that contains pool information. */
...
export interface PoolMetadataProtoMsg {
  typeUrl: "/tendermint.liquidity.v1beta1.PoolMetadata";
  value: Uint8Array;
}
/**
 * Metadata for the state of each pool for invariant checking after genesis
...
export interface PoolMetadataAminoMsg {
  type: "/tendermint.liquidity.v1beta1.PoolMetadata";
...
export interface PoolBatchProtoMsg {
  typeUrl: "/tendermint.liquidity.v1beta1.PoolBatch";
  value: Uint8Array;
}
/**
 * PoolBatch defines the batch or batches of a given liquidity pool that
...
export interface PoolBatchAminoMsg {
  type: "/tendermint.liquidity.v1beta1.PoolBatch";
...
export interface DepositMsgStateProtoMsg {
  typeUrl: "/tendermint.liquidity.v1beta1.DepositMsgState";
  value: Uint8Array;
}
/**
 * DepositMsgState defines the state of deposit message that contains state
...
export interface DepositMsgStateAminoMsg {
  type: "/tendermint.liquidity.v1beta1.DepositMsgState";
...
export interface WithdrawMsgStateProtoMsg {
  typeUrl: "/tendermint.liquidity.v1beta1.WithdrawMsgState";
  value: Uint8Array;
}
/**
 * WithdrawMsgState defines the state of the withdraw message that contains
...
export interface WithdrawMsgStateAminoMsg {
  type: "/tendermint.liquidity.v1beta1.WithdrawMsgState";
...
export interface SwapMsgStateProtoMsg {
  typeUrl: "/tendermint.liquidity.v1beta1.SwapMsgState";
  value: Uint8Array;
}
/**
 * SwapMsgState defines the state of the swap message that contains state
...
export interface SwapMsgStateAminoMsg {
  type: "/tendermint.liquidity.v1beta1.SwapMsgState";
...
export const Params = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          ...
          break;
        case 11:
          message.buildersAddresses.push(reader.string());
          break;
        case 12:
  ...
  fromPartial(object: Partial<Params>): Params {
    ...
    message.buildersAddresses = object.buildersAddresses?.map(e => e) || [];
  ...
  fromAmino(object: ParamsAmino): Params {
    ...
    message.buildersAddresses = object.builders_addresses?.map(e => e) || [];
  ...
  toAmino(message: Params): ParamsAmino {
    ...
    if (message.buildersAddresses) {
      obj.builders_addresses = message.buildersAddresses.map(e => e);
    } else {
