...
export interface PoolRecordProtoMsg {
  typeUrl: "/tendermint.liquidity.v1beta1.PoolRecord";
  value: Uint8Array;
}
/**
 * records the state of each pool after genesis export or import, used to check
...
export interface PoolRecordAminoMsg {
  type: "/tendermint.liquidity.v1beta1.PoolRecord";
...
export interface GenesisStateProtoMsg {
  typeUrl: "/tendermint.liquidity.v1beta1.GenesisState";
  value: Uint8Array;
}
/** GenesisState defines the liquidity module's genesis state. */
...
export interface GenesisStateAminoMsg {
  type: "/tendermint.liquidity.v1beta1.GenesisState";
